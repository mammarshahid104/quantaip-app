            ...
            <View style={styles.card}>
              {[
                ...
                <View key={i} style={styles.feeRow}>
                  ...
                  <Text style={[styles.feeVal, (row as any).highlight && {color: '#7c3aed', fontSize: 16}]}>
                    {row.value}
                  </Text>
                </View>
              ))}
...
const styles = StyleSheet.create({
  ...
  childAvTxt: {fontSize: 14, fontWeight: '700', color: '#7c3aed'},
  childInfo: {flex: 1},
  childName: {fontSize: 15, fontWeight: '700', color: '#1e1b4b'},
  childMeta: {fontSize: 11, color: '#6b7280', marginTop: 2},
  childId: {fontSize: 10, color: '#c4b5fd', marginTop: 1},
  ...
  feeVal: {fontSize: 13, color: '#1e1b4b', fontWeight: '700'},
  notifCard: {
  ...
  notifBody: {flex: 1},
  notifTitle: {fontSize: 14, fontWeight: '700', color: '#1e1b4b', marginBottom: 3},
